...
from predigol_model.diagnostics import build_model_diagnostics, fetch_matches, fetch_prediction_rows, summarize_for_console
...
def main() -> int:
    ...
    diagnostics = build_model_diagnostics(
        fetch_matches(client, settings.history_limit),
        fetch_prediction_rows(client, settings.history_limit),
        settings.min_history_matches,
        "V2",
    )
